...
#%% load the data
lfp = np.load('lfp_1KHz.npy')   #the data included are related to 23 days post implantation
...
plt.title('PSD, channel 1, 23 day post implantation')
plt.xlim([0,60])
...
for i in range(8):
    ...
    plt.errorbar(23, MEAN_FREQ[i], yerr=STD_FERQ[i],
...
ax.set_title('Day post implant: 23')
